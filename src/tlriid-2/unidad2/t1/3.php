...
<section>
    ...
    <?= TabsComponent([
        ...
        <blockquote class="border-l-4 border-sky-400 bg-sky-50 pl-6 pr-4 py-4 my-6 italic text-gray-700">
          ...
          <p class="mt-3">Taciturno, siempre sumido en profundas cavilaciones, distraído, metódico, sumiso con sus superiores, aunque traicionaba su aparente humildad el pliegue altanero de sus labios, severo y riguroso con sus inferiores, económico, laborioso, reservado, frío, este joven tenía aspecto repugnante y, en efecto, era antipático para todo el mundo.</p>
          <p class="text-right text-sm not-italic font-semibold mt-3 text-sky-700">Leobardo Colín Villeda</p>
        </blockquote>
        ...
        <div class="my-6 border border-gray-200 rounded-lg overflow-hidden shadow-sm max-w-3xl mx-auto">
          ...
          <div class="p-6 space-y-4 text-gray-700">
            ...
            <p>Josef K. soñó:</p>
            <p>Era un día hermoso, y K. quiso salir a pasear. Pero apenas dio dos pasos, llegó al cementerio. Vio numerosos e intrincados senderos, muy numerosos y nada prácticos; K. flotaba sobre uno de esos senderos como sobre un torrente, en un inconmovible deslizamiento.</p>
            ...
            <p>El primer breve trazo que dibujó fue un alivio para K. pero el artista tuvo que vencer evidentemente una extraordinaria repugnancia antes de terminarlo; además, la inscripción no era ahora tan hermosa, sobre todo parecía haber mucho menos dorado, los trazos se demoraban, pálidos e inseguros; pero la letra resultó bastante grande.</p>
            <p>Era una J.; estaba casi terminada ya, cuando el artista, furioso, dio un puntapié contra la tumba y la tierra voló por los aires.</p>
