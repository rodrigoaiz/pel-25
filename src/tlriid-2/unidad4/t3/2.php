...
?>
<section>
    <h2>Análisis de las funciones de tiempo y espacio en una novela</h2>

    <div class="flex justify-center mt-4 mb-6">
        <div class="w-2/3">
            <?php
            renderImage(
                'tlriid2-u4t3p2img1.webp',
                'Máquina del tiempo futurista [ilustración]. Generada con Inteligencia Artificial. Freepik.',
                'https://www.freepik.es/imagen-ia-gratis/maquina-tiempo-futurista_225952788.htm',
                'Fuente: Freepik'
            );
            ?>
        </div>
