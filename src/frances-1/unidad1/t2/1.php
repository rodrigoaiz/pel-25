...
<section>
  ...
  renderActividadH5P('je-me-pel', "Je m'appelle", $ActividadContent, true);
  ?>
  ...
  <?php
  $ActividadContent = ob_get_clean();
  renderActividadH5P('formal-informal', "Apprenons à différencier les questions formelles et informelles", $ActividadContent, true);
  ?>
