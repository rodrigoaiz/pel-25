...
<section>
  ...
  renderActividadH5P('u2-act-1', "Mon âge et ma date de naissance", $ActividadContent);
  ?>
  ...
  <?php
  $ActividadContent = ob_get_clean();
  renderActividadH5P('u2-act-2-1', "Quel âge avez-vous? 1", $ActividadContent, true);
  ?>
  <?php ob_start(); ?>
  <?php
  $ActividadContent = ob_get_clean();
  renderActividadH5P('u2-act-2-2', "Quel âge avez-vous? 2", $ActividadContent, true);
  ?>
