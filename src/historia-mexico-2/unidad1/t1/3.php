...
<section>
  ...
  <p>Estas causas llevaron a varias rebeliones y levantamientos en diferentes regiones del país, como la <b>rebelión</b> de los <b>Yaquis</b> en Sonora y la insurrección de <b>Tomóchic</b> en Chihuahua. </p>


     <?php ob_start(); ?>
       <p>A continuación, revisa lo siguiente:</p>
    <?php
      $ActividadContent = ob_get_clean();
      renderActividadH5P('u1a2', "Rebeliones indígenas", $ActividadContent);
    ?>
  ...
  <?php
  $ActividadContent = ob_get_clean();
  renderActividad('u1a3', "Foro: Causas de la Revolución Mexicana", $ActividadContent);
  ?>
