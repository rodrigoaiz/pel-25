...
<section>
  ...
  <ol class="ol-number">
    <li>Lean con atención el texto <a href="<?php echo PATH_DOCS . 'u2t9-Lectura_AQuéLlamamosFeminicidio_Act.9.8.pdf'; ?>" target="_blank">“¿A qué llamamos feminicidio?”</a> de Marcela Lagarde.</li>
    ...
    <li>Revisa la <a href="<?php echo PATH_DOCS . 'u2t9-Rubrica_AQuéLlamamosFeminicidio_Act.9.8.pdf'; ?>" target="_blank">rúbrica</a> para que tengas claridad en lo que se va a evaluar.</li>
   </ol>

    <?php ob_start(); ?>
      <?php
      $ActividadContent = ob_get_clean();
      renderActividad('u2t9a7', "¿A qué llamamos feminicidio?", $ActividadContent);
    ?>
