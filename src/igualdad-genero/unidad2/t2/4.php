...
?>
<section>
    <h2>Mitos del amor romántico</h2>
    ...
    <ol class="ol-number md:ml-32">
        ...
        <li>Al final participa en un <span class="font-bold italic">Padlet</span> que generará tu profesora o profesor. No olvides registrarte con tu nombre completo comenzando por apellidos.</li>
    </ol>
