...
<section>
  ...
  <div class="w-4/5 mx-auto mt-6 bg-fuchsia-900 p-2 leading-none text-md">
    ...
    <ul>
      <li class="text-white">Revisa la <a class="text-white" href="<?php echo PATH_DOCS . 'u1t5-rubrica_ElaboracionDeUnWordArt.pdf'; ?>" target="_blank">rúbrica</a> de evaluación de tu WordArt.</li>
    </ul>
  </div>
  <?php ob_start(); ?>
