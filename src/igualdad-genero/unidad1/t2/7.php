...
<section>
    ...
    <ol class="ol-number ml-32">
        ...
        <li>Sube tu reflexión en formato <strong>.PDF</strong> nombrándolo de la siguiente manera: <em>Nombre_Apellido_ReflexionFinal.</em></li>
    </ol>
    ...
    renderActividad('u1t1a8', "Reflexión sobre la Perspectiva de Género.", $ActividadContent);
    ?>
</section>
