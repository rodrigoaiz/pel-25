...
<section>
  ...
  <?php renderImagePleca('u2_t5_computadora_portatil.webp', 'Imagen de DilokaStudio.', 'https://www.freepik.es/foto-gratis/mano-usando-computadora-portatil-pantalla-virtual-documento-aprobar-linea-concepto-gestion-erp-garantia-calidad-papel_24755711.htm', 'Freepik.', 'justify-center'); ?> <p>Es importante tener en cuenta que las características de propiedad y licencia, distribución y libertad de uso del software pueden variar según el tipo de software y las licencias asociadas. Siempre es recomendable revisar las condiciones específicas establecidas en la licencia de un software en particular para entender los derechos y restricciones asociados con su uso y distribución.</p>
</section>
<?php
