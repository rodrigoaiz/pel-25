...
<section>
  ...
  <div class="my-2 text-center text-xl">
    <p>Consulta el siguiente recurso "Generaciones de computadoras"</p>
  </div>
  <?php renderGenially('64def938bcd477001abfac6b', 'Generaciones de computadoras','max-w-5xl') ?>
  ...
  <div class="my-2 text-center text-xl">
    <p>Consulta el siguiente recurso "Tendencias tecnológicas"</p>
  </div>
  <?php renderGenially('64dfd76873be4600186fc6c2') ?>
  <?php ob_start(); ?>
