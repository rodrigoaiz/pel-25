...
<section>
    ...
    <?php
    renderImagePleca('u4_t2_multimedia.PNG', 'Audio. Imagen de Eucalyp.', 'https://www.flaticon.es/icono-gratis/multimedia_1644133?term=audio&page=1&position=23&origin=search&related_id=1644133', 'Flaticon.', 'justify-center');
    ?>
    </div>
    ...
    <div class="mx-auto max-w-xl">
        <?php renderImage('u4_t2_escritorio.jpg', 'Audio. Imagen de freepik.', 'https://www.freepik.es/vector-gratis/fondo-espacio-trabajo-diseno-grafico-escritorio-herramientas_2047446.htm#query=computadora%20tableta%20audifonos&position=14&from_view=search&track=ais&uuid=10c1b7f0-9fb6-4876-a8ae-8fe705eb4494', 'Freepik.'); ?>
    </div>
    <?php ob_start(); ?>
    ...
    ?>
    <div class="mx-auto max-w-xl">
        <?php renderImage('u4_t2_como_conocer_calidad_archivo_audio.jpg'); ?>
    </div>
    <?php ob_start(); ?>
