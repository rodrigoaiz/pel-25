...
<section>
    ...
    <div class="max-w-4xl mx-auto my-8">
        <?php renderImage('u4_t4_social_media.jpg', 'Imagen de geralt.', 'https://pixabay.com/es/illustrations/medios-de-comunicaci%C3%B3n-social-3758364/', 'Pixabay.', 'justify-center') ?>
    </div>
    ...
    <div class="max-w-3xl mx-auto my-8">
        <?php renderImage('u4_t4_journalist.jpg', 'Imagen de pch.vector.', 'https://www.freepik.com/free-vector/female-journalist-with-microphone-interviewing-man_9649774.htm', 'Freepik.', 'justify-center') ?>
    </div>
    <div class="max-w-3xl mx-auto my-4">
        <div class="rounded-md bg-lime-600/60 p-4 text-teal-950">
            ...
            <p class="text-center"><a href=" <?php echo PATH_DOCS . 'https://es.educaplay.com/recursos-educativos/16043394-comparte_y_difunde.html'; ?>" target="_blank">¿Qué conoces?</a></p>
        ...
        <div class="max-w-2xl mx-auto my-4">
            <?php renderImage('u4_t4_question.jpg', 'Imagen de Storyset.', 'https://www.freepik.com/free-vector/curiosity-people-concept-illustration_30576696.htm', 'Freepik.', 'justify-center') ?>
        </div>
</section>
<?php
