...
?>
<section>
  <h2>Lección 1: Conceptos de salud y enfermedad</h2>
</section>
...
<section>
  ...
  <p>Algunos investigadores han propuesto su concepto de salud. Rene Dubos que en 1956 dijo

  <blockquote class="blockquote-destacado">
    <p>La salud es un estado físico y mental razonablemente libre de incomodidad y dolor, que permite a la persona en cuestión, funcionar efectivamente por el más largo tiempo posible en el ambiente donde por elección está ubicado.</p>
  </blockquote>
  <p>Alessandro Seppilli en 1971, la define como:</p>
  <blockquote class="blockquote-destacado">
    <p>Una condición de equilibrio funcional, tanto mental como físico, conducente a una integración dinámica del individuo en su ambiente natural y social.</p>
  </blockquote>
  <p>Milton Terris en 1975 determinó que</p>
  <blockquote class="blockquote-destacado">
