...
<section>
    ...
    ?>
    <div class="mt-10 min-h-16 text-white text-center pl-8 pr-8 bg-linear-65 from-purple-500 to-pink-500">Una vez concluido todo tu curso de <span class="font-bold">Cultura de Paz en el Marco del Modelo Educativo del CCH</span> descarga e imprime tu reconocimiento.</div>
    <div class="mt-6"><strong>NOTA:</strong> Es muy importante que lo guardes bien, ya que en algún momento de tu estancia en CCH te lo pueden solicitar.</div>
    ...
    <div class="grid grid-cols-6 gap-4 mt-10">
        <div class="col-span-2 col-start-3 bg-linear-to-bl from-violet-500 to-fuchsia-500 text-center text-lg p-2 rounded-lg">
            <a class=" text-white" href="<?php echo PATH_DOCS . 'unidad1-infografia-emociones.pdf'; ?>" target="_blank">
