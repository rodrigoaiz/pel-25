...
<section>
  ...
  <div class="md:grid grid-cols-2 md:gap-4 content-center">
      <div class="...">
          <?php
      ...
      <div class="flex items-center">
          <p>Las emociones son <strong>reacciones biológicas</strong> que nos ayudan a responder ante distintas situaciones y favorecen la supervivencia. Cada emoción tiene una función específica. Sin embargo, cuando se desbordan pueden perjudicarnos, por lo que es <strong>importante aprender a reconocerlas y controlarlas.</strong></p>
      </div>
  </div>
  ...
  renderActividadH5P('actividad-las-emociones', "Crucigrama de las emociones.");
  ?>
</section>
