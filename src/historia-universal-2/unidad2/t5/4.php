...
<section>
 ...
 <p>No podemos terminar esta unidad sin abordar el tema de cómo influyó el arte y la ideología socialista en el movimiento muralista mexicano y el arte de mediados del siglo XX en México.</p>
  ...
  <?php
  renderImagePleca('hu2-u2-frida.webp','Frida Kahlo. Imagen de Guallendra.','https://commons.wikimedia.org/wiki/File:Kahlo_Frida_portant_un_corset_avec_dessin_militant.jpg', 'Wikimedia Commons.');
  ?>
