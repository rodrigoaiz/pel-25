...
<section>
 ...
 ?>
  ...
  ?>
    <?php
  renderImagePleca('hu2-u2-fasces.webp','Fasces. Imagen de Tennppakuranohimarayasenmyaku', 'https://commons.wikimedia.org/wiki/File:PNF_fasces.png','Wikimedia Commons.');
 ?>
