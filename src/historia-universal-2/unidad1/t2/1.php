...
<section>
  ...
  <?php
  renderImage('señorlibertad1.jpg', 'Imagen de señorlibertad', 'https://commons.wikimedia.org/wiki/File:Cartoon_depicting_Leopold_2_and_other_emperial_powers_at_Berlin_conference_1884.jpg', 'Wikimedia Commons');
  ?>
...
?>
<?php
// solucionar lo de la imagen los imperios coloniales
  renderImage('hohum1.jpg', 'La batalla de Ulundi. Imagen de Hohum', 'https://commons.wikimedia.org', 'Wikimedia Commons');
  ?>
  ...
  <?php
  renderImage('hohum1.jpg', 'La batalla de Ulundi. Imagen de Hohum', 'https://commons.wikimedia.org/wiki/File:The_burning_of_Ulundi.jpg', 'Wikimedia Commons');
  ?>
  ...
  <?php
  renderImage('carnicero1.jpg', 'Imagen de carnicero', 'https://commons.wikimedia.org/wiki/File:Elephant_and_Mule_Battery_(%22Dignity_%26_Impudence%22)_WDL11496.png', 'Wikimedia Commons');
  ?>
  ...
  <?php
  renderImage('donald-trung1.jpg', 'Imagen de Donald Trung', 'https://commons.wikimedia.org/wiki/File:Seine-Inf%C3%A9rieure_-_Somme_-_Colonies_-_Album_Artistique_de_la_France_%26_de_ses_Colonies_(1900).jpg', 'Wikimedia Commons');
  ?>
  <?php
  renderImage('imperialismo-colonial.jpg', 'Imagen de Causas, desarrollo y consecuencias del imperialismo colonial del Siglo XIX', 'https://www.profesorfrancisco.es/2013/02/el-imperialismo-colonial.html', 'Wikimedia Commons');
  ?>
