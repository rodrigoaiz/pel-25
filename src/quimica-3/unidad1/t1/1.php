...
<section>
  ...
  <?php
  renderVideoIframe('xvBzzbl6_2w', 'Este es el primer video de la asignatura');
  ?>
  ...
  renderActividad('u1a1', "Cuestionario diagnóstico de autoevaluación", $ActividadContent);
  ?>
</section>
<?php
